...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Login__ = __webpack_require__(152);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Create__ = __webpack_require__(154);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utilities_Form__ = __webpack_require__(150);
/**
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Logs__ = __webpack_require__(151);
...
/* harmony default export */ __webpack_exports__["default"] = (__WEBPACK_IMPORTED_MODULE_0__Helper__["a" /* default */].extend({
    data: function data() {
        return {
            form: new Form({
                title: '',
    ...
    methods: {
        ...
        fetchExercise: function fetchExercise(index) {
            ...
            this.postRequest(this.urls.exercises, { selectedPart: this.form.workouts[index].selectedPart }).then(function (_ref) {
                var data = _ref.data;
        ...
        cacheWorkout: function cacheWorkout() {
            ...
            this.postRequest(this.urls.bodyparts, {}).then(function (_ref2) {
                var data = _ref2.data;

                //from api/bodyparts, put data into bodyparts
                _this3.form.workouts[0].bodyparts = data;
                _this3.form.workouts[0].selectedPart = data[0].id;

                //needs to be returned to have another request
                return _this3.postRequest(_this3.urls.exercises, { selectedPart: _this3.form.workouts[0].selectedPart });
            }).then(function (_ref3) {
                var data = _ref3.data;

                //from api/exercises, put data into exercises
                _this3.form.workouts[0].exercises = data;
                _this3.form.workouts[0].selectedExercise = data[0].id;
                _this3.oCacheWorkout = Object.assign({}, _this3.form.workouts[0]);
...
/* harmony default export */ __webpack_exports__["default"] = (__WEBPACK_IMPORTED_MODULE_1__Helper__["a" /* default */].extend({
    ...
    methods: {
        ajaxFeed: function ajaxFeed() {
            ...
            this.postRequest(this.urls.feed, {}).then(function (response) {
                _this.$store.commit('assignJournalFeed', response.data);
...
var store = new __WEBPACK_IMPORTED_MODULE_1_vuex__["a" /* default */].Store({
    ...
    mutations: {
        assignJournalFeed: function assignJournalFeed(state, data) {
        ...
        addNewJournal: function addNewJournal(state, journal) {
