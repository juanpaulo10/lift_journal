...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Login__ = __webpack_require__(35);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Create__ = __webpack_require__(37);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utilities_Form__ = __webpack_require__(33);
/**
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Logs__ = __webpack_require__(34);
...
var Logs = function () {
    ...
    _createClass(Logs, [{
        ...
        value: function clear() {
            ...
            if (field === null) this.logs.errors = {};
            if (this.hasErrorProp()) delete this.logs.errors[field];
        }
    }, {
        key: 'any',
        value: function any() {
    ...
    methods: {
        ...
        cacheWorkout: function cacheWorkout() {
            ...
            this.postRequest(this.urls.bodyparts, {}).then(function (_ref2) {
                ...
                return _this3.postRequest(_this3.urls.exercises, { selectedExercise: _this3.form.workouts[0].selectedPart });
            }).then(function (_ref3) {
                var data = _ref3.data;
